...
WebUI.setText(findTestObject('Test suite Simple Add/TC1/Page_/input_   _input-273'), GlobalVariable.Internal_Department_Name)
...
WebUI.click(findTestObject('Workflow Action/Electronic/TC2/click at icon of properties of book'))

WebUI.click(findTestObject('Workflow Action/Electronic/TC2/drop icon 1st'))

not_run: WebUI.click(findTestObject('Workflow Action/Electronic/TC2/edit name of book'))

WebUI.setText(findTestObject('Workflow Action/Electronic/TC2/edit name of book'), 'Properties Edited')

WebUI.click(findTestObject('Workflow Action/Electronic/TC2/drop icon 1st'))

WebUI.click(findTestObject('Workflow Action/Electronic/TC2/Save book'))
