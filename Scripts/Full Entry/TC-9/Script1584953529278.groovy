...
WebUI.doubleClick(findTestObject('Test suite Simple Add/TC3/Page_/Page_/td_  3'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Test suite Simple Add/TC8/No Button'), FailureHandling.OPTIONAL)
